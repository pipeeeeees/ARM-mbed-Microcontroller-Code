...
char ssid[32] = "pipeeeeees";     // enter WiFi router ssid inside the quotes
char pwd [32] = "qwertyuiop"; // enter WiFi router password inside the quotes
...
void ESPconfig()
{
    ...
    strcpy(snd, "srv=net.createServer(net.TCP)\r\n");
      ...
      wait(1);
        ...
        strcpy(snd, "conn:send(\"<h1> Hi David, nice checkoff.</h1>\")\r\n");
      SendCMD();
        wait(1);
        
        strcpy(snd, "conn:send(\"<h2> heading size number 2</h2>\")\r\n");
        SendCMD();
        wait(1);
